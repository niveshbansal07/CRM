        ...
        <div className="page-enter">
            ...
            {activeTab === 'human-resources' && (
                <>
                    ...
                    {filtered.length === 0 ? (
                        <EmptyState icon={Users} title="No Human Resources Found" description="Add your first team member to get started."
                            action={<button className="btn-primary" onClick={() => setShowAdd(true)}><Plus size={14} /> Add Human Resource</button>} />
                    ) : (
            ...
            <ConfirmDialog
                ...
                title="Remove Human Resource" message={`Remove "${deleteTarget?.name}" from the team? This action cannot be undone.`}
            />
        </div>
    );
}
